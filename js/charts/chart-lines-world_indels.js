...
//Get the data from World Indels
var arrallindels = [];
var larrallindels = [];
...
$.ajax ({
  dataType: "json",
  async: false,
  url: serverfoca + '/get_timeseries_all_indels',
  success: function(data) {
    var obj = JSON.parse(data);
    for (var i in obj){
        arrallindels.push(obj[i].prop);
        larrallindels.push(obj[i].initdate);
    }
  }
});
